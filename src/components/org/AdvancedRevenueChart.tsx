...
const AdvancedRevenueChart = ({ currency, onCurrencyChange }: AdvancedRevenueChartProps) => {
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="p-3 rounded-lg bg-secondary/50">
              ...
              <p className="text-lg font-bold">
                {formatCurrency(currentTrends?.reduce((sum, d) => sum + d.tickets, 0) || 0, displayCurrency)}
              </p>
            </div>
            <div className="p-3 rounded-lg bg-secondary/50">
              <p className="text-xs text-muted-foreground">Vote Revenue</p>
              <p className="text-lg font-bold">
                {formatCurrency(currentTrends?.reduce((sum, d) => sum + d.votes, 0) || 0, displayCurrency)}
              </p>
            </div>
