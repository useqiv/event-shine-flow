...
interface ContestEmbedGeneratorProps {
  contestId: string;
  contestTitle: string;
}

export const ContestEmbedGenerator: React.FC<ContestEmbedGeneratorProps> = ({
  contestId,
  contestTitle,
}) => {
  ...
  const embedUrl = `${baseUrl}/embed/contest/${contestId}`;
  ...
  title="${contestTitle} - Voting Contest"
></iframe>`;

  const scriptCode = `<div id="useqiv-contest" data-contest-id="${contestId}"></div>
<script src="${baseUrl}/contest-embed.js"></script>`;
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Embed Contest Widget
        </CardTitle>
        <CardDescription>
          Embed this contest on your website so visitors can view contestants and vote
        </CardDescription>
      </CardHeader>
        ...
        <Tabs defaultValue="iframe">
          ...
          <TabsContent value="iframe" className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Copy and paste this code into your website's HTML where you want the contest widget to appear.
            </p>
          </TabsContent>
