...
interface CampaignEmbedGeneratorProps {
  campaignId: string;
  campaignTitle: string;
}

export const CampaignEmbedGenerator: React.FC<CampaignEmbedGeneratorProps> = ({
  campaignId,
  campaignTitle,
}) => {
  ...
  const embedUrl = `${baseUrl}/embed/campaign/${campaignId}`;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Add a donation widget to your website to collect donations directly
        </CardDescription>
      </CardHeader>
        ...
        <Tabs defaultValue="iframe">
          ...
          <TabsContent value="iframe" className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Copy and paste this code into your website's HTML where you want the campaign widget to appear.
            </p>
          </TabsContent>
