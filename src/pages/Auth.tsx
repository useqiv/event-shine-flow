            ...
            <form onSubmit={handleMfaVerify}>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="mfa-code" type="text" placeholder="000000" value={mfaCode} onChange={e => setMfaCode(e.target.value.replace(/\D/g, '').slice(0, 6))} className="text-center text-lg tracking-widest font-mono" maxLength={6} autoFocus />
                </div>
              </CardContent>
      ...
      <div className="w-full max-w-md">
        <div className="mb-8">
          ...
          <Link to="/" className="flex items-center justify-center">
            <img alt="USEQIV" className="h-12 w-auto" src="/lovable-uploads/d7ec8140-f8f1-4a50-bfcc-d4de2001a79c.png" />
          </Link>
        </div>
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin}>
                <CardContent className="space-y-4">
                  ...
                  {!isLocked && remainingAttempts < 5 && remainingAttempts > 0 && <Alert>
                      <AlertTriangle className="h-4 w-4" />
                      <AlertDescription>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="referral-code" type="text" placeholder="Enter referral code" value={referralCode} onChange={e => setReferralCode(e.target.value.toUpperCase())} className="pl-10" />
                    </div>
                    {referralCode && <p className="text-xs text-green-600">You'll get ₦500 bonus when you sign up!</p>}
                  </div>
                </CardContent>
