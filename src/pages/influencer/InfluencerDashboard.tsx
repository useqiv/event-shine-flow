                  ...
                  <div key={link.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        <span className="ml-2 text-xs">({link.events?.currency || link.contests?.vote_currency || link.commission_currency || 'NGN'})</span>
                      </p>
                      {link.contests?.title && (
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-primary font-medium">
                        {formatCurrency(link.total_commission || 0, link.events?.currency || link.contests?.vote_currency || link.commission_currency || 'NGN')} earned
                      </p>
                    </div>
                  </div>
                ))}
