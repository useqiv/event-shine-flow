    ...
    <OrganizationLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">Manage Events</h1>
            <p className="text-sm text-muted-foreground">View and manage all your events.</p>
          </div>
