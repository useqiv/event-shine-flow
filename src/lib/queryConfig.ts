...
export const selectColumns = {
  ...
  contestCard: 'id, title, description, image_url, category, vote_amount, vote_price, vote_currency, is_free_voting, end_date, start_date, is_featured, custom_slug, is_active, total_votes, created_at, updated_at',
  
  // Contests - full details
  contestDetail: 'id, title, description, image_url, category, vote_amount, vote_price, vote_currency, is_free_voting, start_date, end_date, is_active, is_featured, is_live_voting, vote_display_mode, total_votes, custom_slug, brand_logo_url, brand_primary_color, brand_secondary_color, stream_url, stream_platform, organization_id, contest_type, created_at, updated_at',
